...
bool startup_wait_for_usb_console(void)
{
    printf("Press Enter within %u ms for startup menu.\n",
           (unsigned int)DEVICE_STARTUP_CONSOLE_WINDOW_MS);

    absolute_time_t deadline = make_timeout_time_ms(DEVICE_STARTUP_CONSOLE_WINDOW_MS);
    uint8_t ch = 0;
